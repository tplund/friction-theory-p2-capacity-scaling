...
References cited in `paper2_capacity_scaling.md` (Paper 2, "Capacity Scaling of Encoding-Through-Loading: Application vs. Cloze Asymmetry Across Three Orders of Magnitude").

This file is the canonical bibliography for Paper 2's submission package. It mirrors the §8 References section in the master file. Entries are alphabetical.

**Cleanup note 2026-05-01.** This file previously contained ~50 references collected during scoping for content that has since been moved to Paper 4 (encoding-battery, habit-formation/dementia parallels, interference & catastrophic forgetting, triangulation refs, cross-species decision asymmetries). Those references have been migrated to `docs/paper4_bibliography.md`. Only Paper 2-active references remain below.
